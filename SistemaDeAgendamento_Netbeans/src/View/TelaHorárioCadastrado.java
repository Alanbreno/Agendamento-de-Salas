 ...
 * @author Alan Breno
 */
public class TelaHorárioCadastrado extends javax.swing.JDialog {

    /**
     * Creates new form DisciplinaSalva
     */
    public TelaHorárioCadastrado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaHorárioCadastrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaHorárioCadastrado dialog = new TelaHorárioCadastrado(new javax.swing.JFrame(), true);
