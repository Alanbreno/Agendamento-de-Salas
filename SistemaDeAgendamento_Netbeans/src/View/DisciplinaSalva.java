 ...
 * @author Alan Breno
 */
public class DisciplinaSalva extends javax.swing.JDialog {

    /**
     * Creates new form DisciplinaSalva
     */
    public DisciplinaSalva(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisciplinaSalva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DisciplinaSalva dialog = new DisciplinaSalva(new javax.swing.JFrame(), true);
